...
export async function updateSessionEventCount(sessionId: string): Promise<void> {
...
export async function endSession(websiteId: string, sessionId: string): Promise<void> {
  await db
    .update(userSessions)
    .set({
      endTime: new Date(),
...
export async function updateHeartbeat(websiteId: string, sessionId: string, path: string): Promise<void> {
  await db
    .update(userSessions)
    .set({
...
export async function getSession(websiteId: string, sessionId: string): Promise<UserSession | null> {
