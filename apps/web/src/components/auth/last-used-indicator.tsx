...
import { getLastUsedProvider } from "@/lib/auth-client";
...
export function LastUsedIndicator({ className }: LastUsedIndicatorProps) {
  const [lastUsedProvider, setLastUsedProvider] = React.useState<
    "google" | "github" | null
  >(null);
  ...
  const getProviderName = () => {
    return lastUsedProvider === "github" ? "GitHub" : "Google";
  };
