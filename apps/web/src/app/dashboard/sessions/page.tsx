...
export const metadata: Metadata = {
  title: "Sessions",
  description:
    "Monitor active sessions, session duration, and user engagement patterns.",
};
            ...
            <div className="flex items-center gap-4">
              <div className="flex items-center gap-2">
                ...
                <span className="text-gray-400 text-xs">
                  <span className="font-semibold text-white">3</span> total
                  sessions
                </span>
              </div>
              <div className="flex items-center gap-2">
                ...
                <span className="text-gray-400 text-xs">
                  <span className="font-semibold text-white">5m 23s</span> avg
                  duration
                </span>
              </div>
              <div className="flex items-center gap-2">
        ...
        {sessions.length === 0 && (
          <div className="text-center py-12">
            ...
            <p className="text-gray-400 mb-4 text-sm">
              User sessions will appear here once visitors start browsing your
              websites
            </p>
          </div>
        )}
